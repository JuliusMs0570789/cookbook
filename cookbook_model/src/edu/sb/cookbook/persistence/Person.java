...
public class Person extends BaseEntity {
	// TODO: initialize with HashTools method?
	@NotEmpty
	@JoinColumn(nullable=false, updatable=false)
	public String DEFAULT_PASSWORD_HASH;
	...
	public Person(String DEFAULT_PASSWORD_HASH, Set<Recipe> recipes, Name name, Address address, Set<String> phones) {
		super();
